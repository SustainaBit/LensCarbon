...
- open terminal and go into this folder
...
- go to subfolder ``/apps/web``
- create file ``.env`` from ``.env.example``
- enter variable ```NEXT_PUBLIC_LENS_NETWORK="testnet"``` or ``"sandbox"``
- go back to folder ``lenster-main``
- enter ```pnpm dev``` to start development server
